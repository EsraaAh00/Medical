...
namespace Vendor_ProfileManagement.Mapping
{
    public static class OptionMapping
    {
        ...
        //....
        public static Pair<Option, LogModel> FullDataModelToEntity(this Option? entity, OptionFullDataModel model)
        {
            LogModel logModel = new LogModel();
            Option? currentEntity = entity;
            ...
            return new Pair<Option, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static OptionFullDataModel EntityToFullDataModel(Option? entity)
        {
            return new OptionFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(Option? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(Option? entity)
        {
        ...
        private static string GetName(Option? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
