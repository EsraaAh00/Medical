...
namespace Vendor_ProfileManagement.Mapping
{
    public static class FeatureMapping
    {
        ...
        //....
        public static Pair<Feature, LogModel> FullDataModelToEntity(this Feature? entity, FeatureFullDataModel model)
        {
            LogModel logModel = new LogModel();
            Feature? currentEntity = entity;
            ...
            return new Pair<Feature, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static FeatureFullDataModel EntityToFullDataModel(Feature? entity)
        {
            return new FeatureFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(Feature? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(Feature? entity)
        {
        ...
        private static string GetName(Feature? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
