...
namespace Vendor_ProfileManagement.Mapping
{
    public static class SubscriptionPlanMapping
    {
        ...
        //....
        public static Pair<SubscriptionPlan, LogModel> FullDataModelToEntity(this SubscriptionPlan? entity, SubscriptionPlanFullDataModel model)
        {
            LogModel logModel = new LogModel();
            SubscriptionPlan? currentEntity = entity;
            ...
            return new Pair<SubscriptionPlan, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static SubscriptionPlanFullDataModel EntityToFullDataModel(SubscriptionPlan? entity)
        {
            return new SubscriptionPlanFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(SubscriptionPlan? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(SubscriptionPlan? entity)
        {
        ...
        private static string GetName(SubscriptionPlan? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
