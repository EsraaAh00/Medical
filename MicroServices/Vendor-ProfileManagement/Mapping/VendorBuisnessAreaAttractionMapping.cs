...
{
    public static class VendorBusinessAreaAttractionMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....
        public static Pair<VendorBusinessAreaAttraction, LogModel> FullDataModelToEntity(this VendorBusinessAreaAttraction? entity, VendorBusinessAreaAttractionFullDataModel model)
        {
            LogModel logModel = new LogModel();
            VendorBusinessAreaAttraction? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new VendorBusinessAreaAttraction();
            }
            else
            {
            ...
            entity.DistanceValue = model.DistanceValue;
            entity.Image = model.Image;
            entity.VendorBusinessId = model.VendorBusinessId;
            entity.DistanceUnitCode = model.DistanceUnitCode;
            entity.DistanceUnit = model.DistanceUnit;
            ...
            return new Pair<VendorBusinessAreaAttraction, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static VendorBusinessAreaAttractionFullDataModel EntityToFullDataModel(VendorBusinessAreaAttraction? entity)
        {
            return new VendorBusinessAreaAttractionFullDataModel
            {
                Id = entity?.Id ?? 0,
                ...
                DistanceUnitCode = entity?.DistanceUnitCode,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(VendorBusinessAreaAttraction? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(VendorBusinessAreaAttraction? entity)
        {
        ...
        private static string GetName(VendorBusinessAreaAttraction? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
