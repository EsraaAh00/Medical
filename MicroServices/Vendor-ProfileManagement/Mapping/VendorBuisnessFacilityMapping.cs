...
{
    public static class VendorBusinessFacilityMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....
        public static Pair<VendorBusinessFacility, LogModel> FullDataModelToEntity(this VendorBusinessFacility? entity, VendorBusinessFacilityFullDataModel model)
        {
            LogModel logModel = new LogModel();
            VendorBusinessFacility? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new VendorBusinessFacility();
            }
            else
            {
            ...
            return new Pair<VendorBusinessFacility, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static VendorBusinessFacilityFullDataModel EntityToFullDataModel(VendorBusinessFacility? entity)
        {
            return new VendorBusinessFacilityFullDataModel
            {
                Id = entity?.Id ?? 0,
                ...
                FacilityName = (AuthenticationHelper.GetLanuage() == 1) ? entity?.Facility?.Name : entity?.Facility?.NameLocalized,
                FacilityId = entity?.FacilityId,
            };
        }
        private static string GetName(VendorBusinessFacility? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? $"" : $""; }
    }
}
