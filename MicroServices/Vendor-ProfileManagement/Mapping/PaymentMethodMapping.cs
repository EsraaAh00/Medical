...
namespace Vendor_ProfileManagement.Mapping
{
    public static class PaymentMethodMapping
    {
        ...
        //....
        public static Pair<PaymentMethod, LogModel> FullDataModelToEntity(this PaymentMethod? entity, PaymentMethodFullDataModel model)
        {
            LogModel logModel = new LogModel();
            PaymentMethod? currentEntity = entity;
            ...
            return new Pair<PaymentMethod, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static PaymentMethodFullDataModel EntityToFullDataModel(PaymentMethod? entity)
        {
            return new PaymentMethodFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(PaymentMethod? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(PaymentMethod? entity)
        {
        ...
        private static string GetName(PaymentMethod? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
