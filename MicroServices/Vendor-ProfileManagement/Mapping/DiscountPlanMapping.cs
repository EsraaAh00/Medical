...
{
    public static class DiscountPlanMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....
        public static Pair<DiscountPlan, LogModel> FullDataModelToEntity(this DiscountPlan? entity, DiscountPlanFullDataModel model)
        {
            LogModel logModel = new LogModel();
            DiscountPlan? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new DiscountPlan();
            }
            else
            {
            ...
            return new Pair<DiscountPlan, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static DiscountPlanFullDataModel EntityToFullDataModel(DiscountPlan? entity)
        {
            return new DiscountPlanFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(DiscountPlan? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(DiscountPlan? entity)
        {
        ...
        private static string GetName(DiscountPlan? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
