...
{
    public static class ClientMedicalReportMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....

        public static Pair<ClientMedicalReport, LogModel> FullDataModelToEntity(this ClientMedicalReport? entity, ClientMedicalReportFullDataModel model)
        {
            LogModel logModel = new LogModel();
            ClientMedicalReport? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new ClientMedicalReport();
            }
            else
            {
            ...
            return new Pair<ClientMedicalReport, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static ClientMedicalReportFullDataModel EntityToFullDataModel(ClientMedicalReport? entity)
        {
            return new ClientMedicalReportFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(ClientMedicalReport? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(ClientMedicalReport? entity)
        {
        ...
        private static string GetName(ClientMedicalReport? entity) { return AuthenticationHelper.GetLanuage() == 1 ? $"" : $""; }
    }
}
