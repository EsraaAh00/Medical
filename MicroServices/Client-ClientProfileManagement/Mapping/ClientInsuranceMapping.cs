...
{
    public static class ClientInsuranceMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....

        public static Pair<ClientInsurance, LogModel> FullDataModelToEntity(this ClientInsurance? entity, ClientInsuranceFullDataModel model)
        {
            LogModel logModel = new LogModel();
            ClientInsurance? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new ClientInsurance();
            }
            else
            {
            ...
            return new Pair<ClientInsurance, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static ClientInsuranceFullDataModel EntityToFullDataModel(ClientInsurance? entity)
        {
            return new ClientInsuranceFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(ClientInsurance? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(ClientInsurance? entity)
        {
        ...
        private static string GetName(ClientInsurance? entity) { return AuthenticationHelper.GetLanuage() == 1 ? $"" : $""; }
    }
}
