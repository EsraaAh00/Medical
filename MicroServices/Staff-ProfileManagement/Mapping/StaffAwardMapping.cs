...
{
    public static class StaffAwardMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....
        public static Pair<StaffAward, LogModel> FullDataModelToEntity(this StaffAward? entity, StaffAwardFullDataModel model)
        {
            LogModel logModel = new LogModel();
            StaffAward? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new StaffAward();
            }
            else
            {
            ...
            return new Pair<StaffAward, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static StaffAwardFullDataModel EntityToFullDataModel(StaffAward? entity)
        {
            return new StaffAwardFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(StaffAward? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(StaffAward? entity)
        {
        ...
        private static string GetName(StaffAward? entity) { return AuthenticationHelper.GetLanuage() == 1 ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
