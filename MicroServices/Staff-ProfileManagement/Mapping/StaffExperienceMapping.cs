...
{
    public static class StaffExperienceMapping
    {
        //....
        // FullDataModelToEntity Function Map FullDataModel to Entity Used For Save And LogModel Data
        //....
        public static Pair<StaffExperience, LogModel> FullDataModelToEntity(this StaffExperience? entity, StaffExperienceFullDataModel model)
        {
            LogModel logModel = new LogModel();
            StaffExperience? currentEntity = entity;
            string? currentEntityJsonString = null;
            if (entity == null)
            {
                entity = new StaffExperience();
            }
            else
            {
            ...
            return new Pair<StaffExperience, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static StaffExperienceFullDataModel EntityToFullDataModel(StaffExperience? entity)
        {
            return new StaffExperienceFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(StaffExperience? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(StaffExperience? entity)
        {
        ...
        private static string GetName(StaffExperience? entity) { return AuthenticationHelper.GetLanuage() == 1 ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
