...
namespace Shared_GeneralSharedData.Mapping
{
    public static class ClassificationMapping
    {
        ...
        //....
        public static Pair<Classification, LogModel> FullDataModelToEntity(this Classification? entity, ClassificationFullDataModel model)
        {
            LogModel logModel = new LogModel();
            Classification? currentEntity = entity;
            ...
            return new Pair<Classification, LogModel>(entity, logModel);
        }
        //....
        // EntityToFullDataModel Function Map Entity to FullDataModel Used For Select And GetById
        //....
        public static ClassificationFullDataModel EntityToFullDataModel(Classification? entity)
        {
            return new ClassificationFullDataModel
            {
                Id = entity?.Id ?? 0,
        ...
        //....
        public static BaseDropDown EntityToDropDownModel(Classification? entity)
        {
        ...
        //....
        public static OuterIncludeModel EntityToOuterIncludeModel(Classification? entity)
        {
        ...
        private static string GetName(Classification? entity) { return (AuthenticationHelper.GetLanuage() == 1) ? entity?.Name ?? "" : entity?.NameLocalized ?? ""; }
    }
}
